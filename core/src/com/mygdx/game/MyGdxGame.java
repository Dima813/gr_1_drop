...
public class MyGdxGame extends ApplicationAdapter {
	...
	private Texture bucketImege;
	private Sound dropSound;
	private Music rainMusic;

	private OrthographicCamera camera; //для
	...
	public void create() {
		...
		bucketImege = new Texture(Gdx.files.internal("bucket.png"));
	...
	public void render() {
		...
		batch.begin();
		batch.draw(bucketImege, bucket.x, bucket.y);
